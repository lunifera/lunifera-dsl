...
public interface LFeature extends LAnnotationTarget
{
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipse.emf.common.util.EList%><<%org.lunifera.dsl.semantic.common.types.LAnnotationDef%>> _xifexpression = null;\n<%org.lunifera.dsl.semantic.common.types.LFeature%> _this = this;\n<%org.lunifera.dsl.semantic.common.types.LAnnotationTarget%> _annotationInfo = _this.getAnnotationInfo();\nboolean _notEquals = (!<%com.google.common.base.Objects%>.equal(_annotationInfo, null));\nif (_notEquals)\n{\n\t<%org.lunifera.dsl.semantic.common.types.LFeature%> _this_1 = this;\n\t<%org.lunifera.dsl.semantic.common.types.LAnnotationTarget%> _annotationInfo_1 = _this_1.getAnnotationInfo();\n\t_xifexpression = _annotationInfo_1.getAnnotations();\n}\nelse\n{\n\t<%org.lunifera.dsl.semantic.common.types.LFeature%> _this_2 = this;\n\t_xifexpression = _this_2.getAnnotations();\n}\nreturn _xifexpression;'"
   * @generated
   */
