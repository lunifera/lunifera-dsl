 ...
 * <ul>
 *   <li>{@link org.lunifera.dsl.semantic.common.types.impl.LDtCNumericMinImpl#getMin <em>Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LDtCNumericMinImpl extends LLazyResolverImpl implements LDtCNumericMin {
	...
	protected EClass eStaticClass() {
		return LunTypesPackage.Literals.LDT_CNUMERIC_MIN;
	}
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunTypesPackage.LDT_CNUMERIC_MIN__MIN, oldMin, min));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunTypesPackage.LDT_CNUMERIC_MIN__MIN:
				return getMin();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case LunTypesPackage.LDT_CNUMERIC_MIN___IS_FOR_PRIMITIVES:
