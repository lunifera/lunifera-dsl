 ...
 * <ul>
 *   <li>{@link org.lunifera.dsl.semantic.common.types.impl.LDtCDecimalMinImpl#getMin <em>Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LDtCDecimalMinImpl extends LLazyResolverImpl implements LDtCDecimalMin {
	...
	protected EClass eStaticClass() {
		return LunTypesPackage.Literals.LDT_CDECIMAL_MIN;
	}
	...
	public void setMin(float newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunTypesPackage.LDT_CDECIMAL_MIN__MIN, oldMin, min));
	}
