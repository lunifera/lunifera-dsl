...
public abstract class AbstractEntityGrammarSemanticSequencer extends CommonGrammarSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == LunEntityPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case LunEntityPackage.LBEAN_ATTRIBUTE:
			...
			case LunEntityPackage.LENTITY_ATTRIBUTE:
			...
			case LunEntityPackage.LENTITY_FEATURE:
			...
			case LunEntityPackage.LENTITY_MODEL:
			...
			case LunEntityPackage.LTABLE_PER_CLASS_STRATEGY:
			...
			case LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY:
				if(context == grammarAccess.getEntityInheritanceStrategyRule() ||
		...
		else if(semanticObject.eClass().getEPackage() == LunTypesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
	...
	protected void sequence_ColumnPersistenceInfo(EObject context, LEntityColumnPersistenceInfo semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, LunEntityPackage.Literals.LENTITY_COLUMN_PERSISTENCE_INFO__COLUMN_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LunEntityPackage.Literals.LENTITY_COLUMN_PERSISTENCE_INFO__COLUMN_NAME));
		}
