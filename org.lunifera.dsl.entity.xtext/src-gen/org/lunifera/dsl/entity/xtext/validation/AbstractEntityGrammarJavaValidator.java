...
public class AbstractEntityGrammarJavaValidator extends org.lunifera.dsl.common.xtext.validation.CommonGrammarJavaValidator {

	@Override
	protected List<EPackage> getEPackages() {
	    List<EPackage> result = new ArrayList<EPackage>();
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.lunifera.org/dsl/entity/v1"));
