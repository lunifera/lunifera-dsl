...
class PojoJvmModelInferrerDelegate implements IEntityJvmModelInferrerDelegate {
	 ...
	 */
	 @SuppressWarnings({"deprecation"})
		...
		acceptor.accept(e.toEntityClass( e.fullyQualifiedName, settings)).initializeLater [
	 ...
	 */
	 @SuppressWarnings({"deprecation"})
		...
		acceptor.accept(e.toEnumerationType(e.fullyQualifiedName.toString, null)).initializeLater [
			documentation = e.documentation
			//
			// literals
			//
