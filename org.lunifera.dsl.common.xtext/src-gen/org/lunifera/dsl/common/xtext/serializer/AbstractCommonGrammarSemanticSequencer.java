...
public abstract class AbstractCommonGrammarSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == LunTypesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
	...
	protected void sequence_Import(EObject context, LImport semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, LunTypesPackage.Literals.LIMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LunTypesPackage.Literals.LIMPORT__IMPORTED_NAMESPACE));
		}
