 ...
 * {@link org.lunifera.dsl.semantic.entity.LEntity} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LEntityItemProvider extends LClassItemProvider {
	...
	protected void addCacheablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_cacheable_feature", "_UI_LEntity_type"),
				LunEntityPackage.Literals.LENTITY__CACHEABLE, true, false,
	...
	protected void addHistorizedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_historized_feature", "_UI_LEntity_type"),
				LunEntityPackage.Literals.LENTITY__HISTORIZED, true, false,
				false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addTimedependentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_LEntity_timedependent_feature",
								"_UI_LEntity_type"),
						LunEntityPackage.Literals.LENTITY__TIMEDEPENDENT, true,
						false, false,
	...
	protected void addTimedependentDateTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_timedependentDateType_feature",
						"_UI_LEntity_type"),
	...
	protected void addMappedSuperclassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_mappedSuperclass_feature",
						"_UI_LEntity_type"),
				LunEntityPackage.Literals.LENTITY__MAPPED_SUPERCLASS, true,
	...
	protected void addSuperTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_superType_feature", "_UI_LEntity_type"),
				LunEntityPackage.Literals.LENTITY__SUPER_TYPE, true, false,
				true, null, null, null));
	}
	...
	protected void addSubTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_LEntity_subTypes_feature", "_UI_LEntity_type"),
				LunEntityPackage.Literals.LENTITY__SUB_TYPES, true, false,
				true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(LunEntityPackage.Literals.LENTITY__PERSISTENCE_INFO);
			childrenFeatures
					.add(LunEntityPackage.Literals.LENTITY__INHERITANCE_STRATEGY);
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_LEntity_type")
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == LunTypesPackage.Literals.LTYPE__ANNOTATION_INFO
