...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.entity.LBeanToEntityReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LBeanToEntityReferenceItemProvider extends LBeanFeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LBeanToEntityReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LBeanToEntityReference_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LBeanToEntityReference_type_feature", "_UI_LBeanToEntityReference_type"),
				 LunEntityPackage.Literals.LBEAN_TO_ENTITY_REFERENCE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns LBeanToEntityReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LBeanToEntityReference"));
	}
	...
	public String getText(Object object) {
		String label = ((LBeanToEntityReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LBeanToEntityReference_type") :
			getString("_UI_LBeanToEntityReference_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LBeanToEntityReference.class)) {
