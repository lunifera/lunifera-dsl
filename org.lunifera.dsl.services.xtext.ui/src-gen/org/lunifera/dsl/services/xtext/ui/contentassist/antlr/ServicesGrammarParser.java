		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassAccess().getGetExpressionAssignment_9_1(), "rule__Class__GetExpressionAssignment_9_1");
					put(grammarAccess.getClassAccess().getFindExpressionAssignment_10_1(), "rule__Class__FindExpressionAssignment_10_1");
					put(grammarAccess.getClassAccess().getFindExpressionWithDelimiterAssignment_11_1(), "rule__Class__FindExpressionWithDelimiterAssignment_11_1");
					put(grammarAccess.getClassAccess().getUpdateExpressionAssignment_12_1(), "rule__Class__UpdateExpressionAssignment_12_1");
					put(grammarAccess.getClassAccess().getDeleteExpressionAssignment_13_1(), "rule__Class__DeleteExpressionAssignment_13_1");
