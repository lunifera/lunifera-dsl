...
* generated by Xtext
*/
package org.lunifera.dsl.services.xtext.ui.contentassist.antlr;
...
public class ServicesGrammarParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.lunifera.dsl.services.xtext.ui.contentassist.antlr.internal.InternalServicesGrammarParser createParser() {
		org.lunifera.dsl.services.xtext.ui.contentassist.antlr.internal.InternalServicesGrammarParser result = new org.lunifera.dsl.services.xtext.ui.contentassist.antlr.internal.InternalServicesGrammarParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassAccess().getPersistenceIdAssignment_8_1(), "rule__Class__PersistenceIdAssignment_8_1");
					put(grammarAccess.getClassAccess().getInjectedServicesAssignment_9(), "rule__Class__InjectedServicesAssignment_9");
					put(grammarAccess.getClassAccess().getGetExpressionAssignment_10_1(), "rule__Class__GetExpressionAssignment_10_1");
					put(grammarAccess.getClassAccess().getFindExpressionAssignment_11_1(), "rule__Class__FindExpressionAssignment_11_1");
					put(grammarAccess.getClassAccess().getFindExpressionWithDelimiterAssignment_12_1(), "rule__Class__FindExpressionWithDelimiterAssignment_12_1");
					put(grammarAccess.getClassAccess().getUpdateExpressionAssignment_13_1(), "rule__Class__UpdateExpressionAssignment_13_1");
					put(grammarAccess.getClassAccess().getDeleteExpressionAssignment_14_1(), "rule__Class__DeleteExpressionAssignment_14_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.lunifera.dsl.services.xtext.ui.contentassist.antlr.internal.InternalServicesGrammarParser typedParser = (org.lunifera.dsl.services.xtext.ui.contentassist.antlr.internal.InternalServicesGrammarParser) parser;
