...
public class LDtoMapperImpl extends MinimalEObjectImpl.Container implements LDtoMapper
{
  ...
  {
    return DtoPackage.Literals.LDTO_MAPPER;
  }
  ...
  public NotificationChain basicSetToDTO(XExpression newToDTO, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_MAPPER__TO_DTO, oldToDTO, newToDTO);
  ...
  public void setToDTO(XExpression newToDTO)
  {
    if (newToDTO != toDTO)
    {
      ...
      if (toDTO != null)
        msgs = ((InternalEObject)toDTO).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DtoPackage.LDTO_MAPPER__TO_DTO, null, msgs);
      if (newToDTO != null)
        msgs = ((InternalEObject)newToDTO).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DtoPackage.LDTO_MAPPER__TO_DTO, null, msgs);
      msgs = basicSetToDTO(newToDTO, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_MAPPER__TO_DTO, newToDTO, newToDTO));
  }
  ...
  public NotificationChain basicSetFromDTO(XExpression newFromDTO, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_MAPPER__FROM_DTO, oldFromDTO, newFromDTO);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFromDTO(XExpression newFromDTO)
  {
    if (newFromDTO != fromDTO)
    {
      NotificationChain msgs = null;
      if (fromDTO != null)
        msgs = ((InternalEObject)fromDTO).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DtoPackage.LDTO_MAPPER__FROM_DTO, null, msgs);
      if (newFromDTO != null)
        msgs = ((InternalEObject)newFromDTO).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DtoPackage.LDTO_MAPPER__FROM_DTO, null, msgs);
      msgs = basicSetFromDTO(newFromDTO, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_MAPPER__FROM_DTO, newFromDTO, newFromDTO));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO_MAPPER__TO_DTO:
        return basicSetToDTO(null, msgs);
      case DtoPackage.LDTO_MAPPER__FROM_DTO:
