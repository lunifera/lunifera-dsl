...
public class LDtoInheritedAttributeImpl extends LDtoAbstractAttributeImpl implements LDtoInheritedAttribute
{
  ...
  {
    return DtoPackage.Literals.LDTO_INHERITED_ATTRIBUTE;
  }
    ...
    if (inheritedFeature != null && inheritedFeature.eIsProxy())
    {
      ...
      if (inheritedFeature != oldInheritedFeature)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DtoPackage.LDTO_INHERITED_ATTRIBUTE__INHERITED_FEATURE, oldInheritedFeature, inheritedFeature));
      }
    }
  ...
  public void setInheritedFeature(LAttribute newInheritedFeature)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_INHERITED_ATTRIBUTE__INHERITED_FEATURE, oldInheritedFeature, inheritedFeature));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO_INHERITED_ATTRIBUTE__INHERITED_FEATURE:
