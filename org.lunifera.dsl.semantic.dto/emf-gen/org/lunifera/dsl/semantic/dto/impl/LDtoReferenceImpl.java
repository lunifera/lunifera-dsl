...
public class LDtoReferenceImpl extends LDtoAbstractReferenceImpl implements LDtoReference
{
  ...
  {
    return DtoPackage.Literals.LDTO_REFERENCE;
  }
    ...
    if (opposite != null && opposite.eIsProxy())
    {
      ...
      if (opposite != oldOpposite)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DtoPackage.LDTO_REFERENCE__OPPOSITE, oldOpposite, opposite));
      }
    }
    return opposite;
  }
  ...
  public void setOpposite(LDtoReference newOpposite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_REFERENCE__OPPOSITE, oldOpposite, opposite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO_REFERENCE__OPPOSITE:
