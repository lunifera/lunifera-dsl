...
public class LDtoInheritedReferenceImpl extends LDtoAbstractReferenceImpl implements LDtoInheritedReference
{
  ...
  {
    return DtoPackage.Literals.LDTO_INHERITED_REFERENCE;
  }
    ...
    if (inheritedFeature != null && inheritedFeature.eIsProxy())
    {
      ...
      if (inheritedFeature != oldInheritedFeature)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DtoPackage.LDTO_INHERITED_REFERENCE__INHERITED_FEATURE, oldInheritedFeature, inheritedFeature));
      }
    }
  ...
  public void setInheritedFeature(LReference newInheritedFeature)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO_INHERITED_REFERENCE__INHERITED_FEATURE, oldInheritedFeature, inheritedFeature));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO_INHERITED_REFERENCE__INHERITED_FEATURE:
