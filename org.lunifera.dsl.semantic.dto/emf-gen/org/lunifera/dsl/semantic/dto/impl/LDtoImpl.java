...
public class LDtoImpl extends LClassImpl implements LDto
{
  ...
  {
    return DtoPackage.Literals.LDTO;
  }
  ...
  public EList<LDtoFeature> getFeatures()
  {
    if (features == null)
    {
      features = new EObjectContainmentEList<LDtoFeature>(LDtoFeature.class, this, DtoPackage.LDTO__FEATURES);
    }
    return features;
  }
  ...
  public NotificationChain basicSetSuperType(LDto newSuperType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO__SUPER_TYPE, oldSuperType, newSuperType);
  ...
  public void setSuperType(LDto newSuperType)
  {
    if (newSuperType != superType)
    {
      ...
      if (superType != null)
        msgs = ((InternalEObject)superType).eInverseRemove(this, DtoPackage.LDTO__SUB_TYPES, LDto.class, msgs);
      if (newSuperType != null)
        msgs = ((InternalEObject)newSuperType).eInverseAdd(this, DtoPackage.LDTO__SUB_TYPES, LDto.class, msgs);
      msgs = basicSetSuperType(newSuperType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO__SUPER_TYPE, newSuperType, newSuperType));
  }
  ...
  public EList<LDto> getSubTypes()
  {
    if (subTypes == null)
    {
      subTypes = new EObjectWithInverseResolvingEList<LDto>(LDto.class, this, DtoPackage.LDTO__SUB_TYPES, DtoPackage.LDTO__SUPER_TYPE);
    }
    return subTypes;
  }
  ...
  public LType getWrappedType()
  {
    if (wrappedType != null && wrappedType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DtoPackage.LDTO__WRAPPED_TYPE, oldWrappedType, wrappedType));
      }
    }
    return wrappedType;
  }
  ...
  public void setWrappedType(LType newWrappedType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DtoPackage.LDTO__WRAPPED_TYPE, oldWrappedType, wrappedType));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO__SUPER_TYPE:
        if (superType != null)
          msgs = ((InternalEObject)superType).eInverseRemove(this, DtoPackage.LDTO__SUB_TYPES, LDto.class, msgs);
        return basicSetSuperType((LDto)otherEnd, msgs);
      case DtoPackage.LDTO__SUB_TYPES:
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DtoPackage.LDTO__FEATURES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case DtoPackage.LDTO__SUB_TYPES:
        return getSubTypes();
      case DtoPackage.LDTO__WRAPPED_TYPE:
