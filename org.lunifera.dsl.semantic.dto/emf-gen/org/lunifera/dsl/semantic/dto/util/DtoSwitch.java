...
public class DtoSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DtoPackage.LDTO_ABSTRACT_ATTRIBUTE:
      {
      ...
      case DtoPackage.LDTO_INHERITED_ATTRIBUTE:
      {
      ...
      case DtoPackage.LDTO_ATTRIBUTE:
      {
      ...
      case DtoPackage.LDTO_ABSTRACT_REFERENCE:
      {
      ...
      case DtoPackage.LDTO_INHERITED_REFERENCE:
      {
      ...
      case DtoPackage.LDTO_REFERENCE:
      {
      ...
      case DtoPackage.LDTO_OPERATION:
      {
