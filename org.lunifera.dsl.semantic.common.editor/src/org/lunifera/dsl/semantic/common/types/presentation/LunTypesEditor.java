 ...
 * 
 */
public class LunTypesEditor extends InteractiveEEFEditor {
		...
		try {
			{
				...
				{
					final EEFTreeMDFormPage page = new EEFTreeMDFormPage(LunTypesEditor.this, "main") {
						...
						public void createPartControl(Composite parent) {
							...
							getModelViewer().addSelectionChangedListener(new ISelectionChangedListener() {
								...
								public void selectionChanged(SelectionChangedEvent selectionChangedEvent) {
									LunTypesEditor.this.setSelection(selectionChangedEvent.getSelection());
								}
							}
