...
public class LEntityReferenceImpl extends LEntityFeatureImpl implements LEntityReference
{
  ...
  {
    return EntityPackage.Literals.LENTITY_REFERENCE;
  }
  ...
  public void setLazy(boolean newLazy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LENTITY_REFERENCE__LAZY, oldLazy, lazy));
  }
  ...
  public void setCascading(boolean newCascading)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LENTITY_REFERENCE__CASCADING, oldCascading, cascading));
  }
  ...
  public LEntity getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntityPackage.LENTITY_REFERENCE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(LEntity newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LENTITY_REFERENCE__TYPE, oldType, type));
  }
  ...
  public LEntityReference getOpposite()
  {
    if (opposite != null && opposite.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntityPackage.LENTITY_REFERENCE__OPPOSITE, oldOpposite, opposite));
      }
    }
    return opposite;
  }
  ...
  public void setOpposite(LEntityReference newOpposite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LENTITY_REFERENCE__OPPOSITE, oldOpposite, opposite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EntityPackage.LENTITY_REFERENCE__LAZY:
        return isLazy();
      case EntityPackage.LENTITY_REFERENCE__CASCADING:
        return isCascading();
      case EntityPackage.LENTITY_REFERENCE__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case EntityPackage.LENTITY_REFERENCE__OPPOSITE:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == LReference.class)
    {
      ...
      {
        case EntityPackage.LENTITY_REFERENCE__LAZY: return LunTypesPackage.LREFERENCE__LAZY;
        case EntityPackage.LENTITY_REFERENCE__CASCADING: return LunTypesPackage.LREFERENCE__CASCADING;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == LReference.class)
    {
      ...
      {
        case LunTypesPackage.LREFERENCE__LAZY: return EntityPackage.LENTITY_REFERENCE__LAZY;
        case LunTypesPackage.LREFERENCE__CASCADING: return EntityPackage.LENTITY_REFERENCE__CASCADING;
        default: return -1;
      }
    }
