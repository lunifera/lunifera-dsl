...
public class LBeanReferenceImpl extends LBeanFeatureImpl implements LBeanReference
{
  ...
  {
    return EntityPackage.Literals.LBEAN_REFERENCE;
  }
  ...
  public void setLazy(boolean newLazy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LBEAN_REFERENCE__LAZY, oldLazy, lazy));
  }
  ...
  public void setCascading(boolean newCascading)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LBEAN_REFERENCE__CASCADING, oldCascading, cascading));
  }
  ...
  public LBean getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntityPackage.LBEAN_REFERENCE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(LBean newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LBEAN_REFERENCE__TYPE, oldType, type));
  }
  ...
  public LBeanReference getOpposite()
  {
    if (opposite != null && opposite.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntityPackage.LBEAN_REFERENCE__OPPOSITE, oldOpposite, opposite));
      }
    }
    return opposite;
  }
  ...
  public void setOpposite(LBeanReference newOpposite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LBEAN_REFERENCE__OPPOSITE, oldOpposite, opposite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EntityPackage.LBEAN_REFERENCE__LAZY:
        return isLazy();
      case EntityPackage.LBEAN_REFERENCE__CASCADING:
        return isCascading();
      case EntityPackage.LBEAN_REFERENCE__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case EntityPackage.LBEAN_REFERENCE__OPPOSITE:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == LReference.class)
    {
      ...
      {
        case EntityPackage.LBEAN_REFERENCE__LAZY: return LunTypesPackage.LREFERENCE__LAZY;
        case EntityPackage.LBEAN_REFERENCE__CASCADING: return LunTypesPackage.LREFERENCE__CASCADING;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == LReference.class)
    {
      ...
      {
        case LunTypesPackage.LREFERENCE__LAZY: return EntityPackage.LBEAN_REFERENCE__LAZY;
        case LunTypesPackage.LREFERENCE__CASCADING: return EntityPackage.LBEAN_REFERENCE__CASCADING;
        default: return -1;
      }
    }
