...
public class LTablePerSubclassStrategyImpl extends MinimalEObjectImpl.Container implements LTablePerSubclassStrategy
{
  ...
  {
    return LunEntityPackage.Literals.LTABLE_PER_SUBCLASS_STRATEGY;
  }
  ...
  public void setDiscriminatorColumn(String newDiscriminatorColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn, discriminatorColumn));
  }
  ...
  public void setDiscriminatorType(LDiscriminatorType newDiscriminatorType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_TYPE, oldDiscriminatorType, discriminatorType));
  }
  ...
  public void setDiscriminatorValue(String newDiscriminatorValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_VALUE, oldDiscriminatorValue, discriminatorValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_COLUMN:
        return getDiscriminatorColumn();
      case LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_TYPE:
        return getDiscriminatorType();
      case LunEntityPackage.LTABLE_PER_SUBCLASS_STRATEGY__DISCRIMINATOR_VALUE:
