...
public class LTablePerClassStrategyImpl extends MinimalEObjectImpl.Container implements LTablePerClassStrategy
{
  ...
  {
    return LunEntityPackage.Literals.LTABLE_PER_CLASS_STRATEGY;
  }
  ...
  public void setDiscriminatorColumn(String newDiscriminatorColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn, discriminatorColumn));
  }
  ...
  public void setDiscriminatorType(LDiscriminatorType newDiscriminatorType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_TYPE, oldDiscriminatorType, discriminatorType));
  }
  ...
  public void setDiscriminatorValue(String newDiscriminatorValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_VALUE, oldDiscriminatorValue, discriminatorValue));
  }
