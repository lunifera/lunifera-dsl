 ...
 * <ul>
 *   <li>{@link org.lunifera.dsl.semantic.entity.impl.LTablePerClassStrategyImpl#getDiscriminatorColumn <em>Discriminator Column</em>}</li>
 *   <li>{@link org.lunifera.dsl.semantic.entity.impl.LTablePerClassStrategyImpl#getDiscriminatorType <em>Discriminator Type</em>}</li>
 *   <li>{@link org.lunifera.dsl.semantic.entity.impl.LTablePerClassStrategyImpl#getDiscriminatorValue <em>Discriminator Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LTablePerClassStrategyImpl extends MinimalEObjectImpl.Container implements LTablePerClassStrategy
{
  ...
  {
    return EntityPackage.Literals.LTABLE_PER_CLASS_STRATEGY;
  }
  ...
  public void setDiscriminatorColumn(String newDiscriminatorColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn, discriminatorColumn));
  }
  ...
  public void setDiscriminatorType(LDiscriminatorType newDiscriminatorType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_TYPE, oldDiscriminatorType, discriminatorType));
  }
  ...
  public void setDiscriminatorValue(String newDiscriminatorValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_VALUE, oldDiscriminatorValue, discriminatorValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_COLUMN:
        return getDiscriminatorColumn();
      case EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_TYPE:
        return getDiscriminatorType();
      case EntityPackage.LTABLE_PER_CLASS_STRATEGY__DISCRIMINATOR_VALUE:
