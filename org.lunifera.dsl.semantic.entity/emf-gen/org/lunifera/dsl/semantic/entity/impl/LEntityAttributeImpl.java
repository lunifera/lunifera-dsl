...
public class LEntityAttributeImpl extends LEntityFeatureImpl implements LEntityAttribute {
	...
	protected EClass eStaticClass() {
		return LunEntityPackage.Literals.LENTITY_ATTRIBUTE;
	}
	...
	public void setId(boolean newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__ID, oldId, id));
	}
	...
	public void setUuid(boolean newUuid) {
		...
		uuid = newUuid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__UUID, oldUuid, uuid));
	}
	...
	public void setVersion(boolean newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__VERSION, oldVersion, version));
	}
	...
	public void setLazy(boolean newLazy) {
		...
		lazy = newLazy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__LAZY, oldLazy, lazy));
	}
	...
	public void setCascading(boolean newCascading) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__CASCADING, oldCascading, cascading));
	}
	...
	public void setTransient(boolean newTransient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__TRANSIENT, oldTransient, transient_));
	}
	...
	public void setDomainKey(boolean newDomainKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__DOMAIN_KEY, oldDomainKey, domainKey));
	}
	...
	public void setDomainDescription(boolean newDomainDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__DOMAIN_DESCRIPTION, oldDomainDescription, domainDescription));
	}
	...
	public NotificationChain basicSetDerivedGetterExpression(XExpression newDerivedGetterExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__DERIVED_GETTER_EXPRESSION, oldDerivedGetterExpression, newDerivedGetterExpression);
	...
	public void setDerivedGetterExpression(XExpression newDerivedGetterExpression) {
		if (newDerivedGetterExpression != derivedGetterExpression) {
			...
			if (derivedGetterExpression != null)
				msgs = ((InternalEObject)derivedGetterExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LunEntityPackage.LENTITY_ATTRIBUTE__DERIVED_GETTER_EXPRESSION, null, msgs);
			if (newDerivedGetterExpression != null)
				msgs = ((InternalEObject)newDerivedGetterExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LunEntityPackage.LENTITY_ATTRIBUTE__DERIVED_GETTER_EXPRESSION, null, msgs);
			msgs = basicSetDerivedGetterExpression(newDerivedGetterExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__DERIVED_GETTER_EXPRESSION, newDerivedGetterExpression, newDerivedGetterExpression));
	}
	...
	public LScalarType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunEntityPackage.LENTITY_ATTRIBUTE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(LScalarType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunEntityPackage.LENTITY_ATTRIBUTE__TYPE, oldType, type));
	}
		...
		final Function1<LImport, Boolean> _function = new Function1<LImport, Boolean>() {
			public Boolean apply(final LImport it) {
				boolean _xblockexpression = false;
				{
					...
					LScalarType _type = LEntityAttributeImpl.this.getType();
					String _fqn = LEntityAttributeImpl.this.toFqn(_type);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LAttribute.class) {
			switch (derivedFeatureID) {
				case LunEntityPackage.LENTITY_ATTRIBUTE__ID: return LunTypesPackage.LATTRIBUTE__ID;
				case LunEntityPackage.LENTITY_ATTRIBUTE__UUID: return LunTypesPackage.LATTRIBUTE__UUID;
				case LunEntityPackage.LENTITY_ATTRIBUTE__VERSION: return LunTypesPackage.LATTRIBUTE__VERSION;
				case LunEntityPackage.LENTITY_ATTRIBUTE__LAZY: return LunTypesPackage.LATTRIBUTE__LAZY;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LAttribute.class) {
			switch (baseFeatureID) {
				case LunTypesPackage.LATTRIBUTE__ID: return LunEntityPackage.LENTITY_ATTRIBUTE__ID;
				case LunTypesPackage.LATTRIBUTE__UUID: return LunEntityPackage.LENTITY_ATTRIBUTE__UUID;
				case LunTypesPackage.LATTRIBUTE__VERSION: return LunEntityPackage.LENTITY_ATTRIBUTE__VERSION;
				case LunTypesPackage.LATTRIBUTE__LAZY: return LunEntityPackage.LENTITY_ATTRIBUTE__LAZY;
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == LAttribute.class) {
			switch (baseOperationID) {
				case LunTypesPackage.LATTRIBUTE___IS_TYPE_VALID: return LunEntityPackage.LENTITY_ATTRIBUTE___IS_TYPE_VALID;
				case LunTypesPackage.LATTRIBUTE___IS_TYPE_IMPORTED: return LunEntityPackage.LENTITY_ATTRIBUTE___IS_TYPE_IMPORTED;
				case LunTypesPackage.LATTRIBUTE___TO_FQN__LTYPE: return LunEntityPackage.LENTITY_ATTRIBUTE___TO_FQN__LTYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case LunEntityPackage.LENTITY_ATTRIBUTE___IS_TYPE_VALID:
				return isTypeValid();
			case LunEntityPackage.LENTITY_ATTRIBUTE___IS_TYPE_IMPORTED:
				return isTypeImported();
			case LunEntityPackage.LENTITY_ATTRIBUTE___TO_FQN__LTYPE:
