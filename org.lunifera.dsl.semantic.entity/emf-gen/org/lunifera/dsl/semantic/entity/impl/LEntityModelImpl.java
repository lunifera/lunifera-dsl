...
public class LEntityModelImpl extends MinimalEObjectImpl.Container implements LEntityModel {
	...
	protected EClass eStaticClass() {
		return LunEntityPackage.Literals.LENTITY_MODEL;
	}
	...
	public EList<LTypedPackage> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentEList<LTypedPackage>(LTypedPackage.class, this, LunEntityPackage.LENTITY_MODEL__PACKAGES);
		}
		return packages;
	}
