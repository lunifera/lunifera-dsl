 ...
 * </p>
 *
 * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity()
 * @model
 * @generated
 */
public interface LEntity extends LClass, LFeaturesHolder
{
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_Cacheable()
   * @model unique="false"
   * @generated
   */
  boolean isCacheable();
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_Historized()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_MappedSuperclass()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_PersistenceInfo()
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_InheritanceStrategy()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_Features()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.lunifera.dsl.semantic.entity.EntityPackage#getLEntity_Indexes()
   * @model containment="true"
   * @generated
   */
