 ...
 * <ul>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#isCacheable <em>
 * Cacheable</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#isHistorized
 * <em>Historized</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#isTimedependent
 * <em>Timedependent</em>}</li>
 * <li>
 * {@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getTimedependentDateType
 * <em>Timedependent Date Type</em>}</li>
 * <li>
 * {@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#isMappedSuperclass
 * <em>Mapped Superclass</em>}</li>
 * <li>
 * {@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getPersistenceInfo
 * <em>Persistence Info</em>}</li>
 * <li>
 * {@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getInheritanceStrategy
 * <em>Inheritance Strategy</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getFeatures <em>
 * Features</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getIndexes <em>
 * Indexes</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getSuperType
 * <em>Super Type</em>}</li>
 * <li>{@link org.lunifera.dsl.semantic.entity.impl.LEntityImpl#getSubTypes <em>
 * Sub Types</em>}</li>
 * </ul>
 * </p>
 * 
...
public class LEntityImpl extends LClassImpl implements LEntity {
	...
	/**
	 * The default value of the '{@link #isTimedependent()
	 * <em>Timedependent</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isTimedependent()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isTimedependent()
	 * <em>Timedependent</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isTimedependent()
	...
	/**
	 * The default value of the '{@link #getTimedependentDateType()
	 * <em>Timedependent Date Type</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getTimedependentDateType()
	 * <em>Timedependent Date Type</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getTimedependentDateType()
	...
	/**
	 * The default value of the '{@link #isMappedSuperclass()
	 * <em>Mapped Superclass</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isMappedSuperclass()
	 * <em>Mapped Superclass</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isMappedSuperclass()
	...
	/**
	 * The cached value of the '{@link #getPersistenceInfo()
	 * <em>Persistence Info</em>}' containment reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getInheritanceStrategy()
	 * <em>Inheritance Strategy</em>}' containment reference. <!--
	...
	/**
	 * The cached value of the '{@link #getSubTypes() <em>Sub Types</em>}'
	...
	public void setTimedependent(boolean newTimedependent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__TIMEDEPENDENT, oldTimedependent,
					timedependent));
	}
	...
	public void setTimedependentDateType(LDateType newTimedependentDateType) {
		...
		timedependentDateType = newTimedependentDateType == null ? TIMEDEPENDENT_DATE_TYPE_EDEFAULT
				: newTimedependentDateType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__TIMEDEPENDENT_DATE_TYPE,
					oldTimedependentDateType, timedependentDateType));
	}
	...
	public void setMappedSuperclass(boolean newMappedSuperclass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__MAPPED_SUPERCLASS,
					oldMappedSuperclass, mappedSuperclass));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPersistenceInfo(
			LEntityPersistenceInfo newPersistenceInfo, NotificationChain msgs) {
		LEntityPersistenceInfo oldPersistenceInfo = persistenceInfo;
		persistenceInfo = newPersistenceInfo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EntityPackage.LENTITY__PERSISTENCE_INFO,
					oldPersistenceInfo, newPersistenceInfo);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPersistenceInfo(LEntityPersistenceInfo newPersistenceInfo) {
		if (newPersistenceInfo != persistenceInfo) {
			...
			if (persistenceInfo != null)
				msgs = ((InternalEObject) persistenceInfo).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- EntityPackage.LENTITY__PERSISTENCE_INFO,
						null, msgs);
			if (newPersistenceInfo != null)
				msgs = ((InternalEObject) newPersistenceInfo).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- EntityPackage.LENTITY__PERSISTENCE_INFO,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__PERSISTENCE_INFO,
					newPersistenceInfo, newPersistenceInfo));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInheritanceStrategy(
			LEntityInheritanceStrategy newInheritanceStrategy,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					EntityPackage.LENTITY__INHERITANCE_STRATEGY,
					oldInheritanceStrategy, newInheritanceStrategy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setInheritanceStrategy(
			LEntityInheritanceStrategy newInheritanceStrategy) {
		if (newInheritanceStrategy != inheritanceStrategy) {
			NotificationChain msgs = null;
			if (inheritanceStrategy != null)
				msgs = ((InternalEObject) inheritanceStrategy).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- EntityPackage.LENTITY__INHERITANCE_STRATEGY,
						null, msgs);
			if (newInheritanceStrategy != null)
				msgs = ((InternalEObject) newInheritanceStrategy).eInverseAdd(
						this, EOPPOSITE_FEATURE_BASE
								- EntityPackage.LENTITY__INHERITANCE_STRATEGY,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__INHERITANCE_STRATEGY,
					newInheritanceStrategy, newInheritanceStrategy));
	}
	...
	public EList<LEntityFeature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<LEntityFeature>(
					LEntityFeature.class, this, EntityPackage.LENTITY__FEATURES);
		}
		return features;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSuperType(LEntity newSuperType,
			NotificationChain msgs) {
		LEntity oldSuperType = superType;
		superType = newSuperType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EntityPackage.LENTITY__SUPER_TYPE,
		...
		if (newSuperType != superType) {
			...
			if (superType != null)
				msgs = ((InternalEObject) superType).eInverseRemove(this,
						EntityPackage.LENTITY__SUB_TYPES, LEntity.class, msgs);
			if (newSuperType != null) {
				// if (newSuperType.eIsProxy()) {
				// org.eclipse.emf.ecore.InternalEObject proxy =
				// (org.eclipse.emf.ecore.InternalEObject)
				// EntityFactory.eINSTANCE
				// .createLEntity();
				// proxy.eSetProxyURI(EcoreUtil.getURI(this));
				// msgs = ((InternalEObject) newSuperType).eInverseAdd(proxy,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EntityPackage.LENTITY__SUPER_TYPE, newSuperType,
					newSuperType));
	}
	...
	public EList<LEntity> getSubTypes() {
		if (subTypes == null) {
			subTypes = new EObjectWithInverseResolvingEList<LEntity>(
					LEntity.class, this, EntityPackage.LENTITY__SUB_TYPES,
					EntityPackage.LENTITY__SUPER_TYPE);
		}
		return subTypes;
	}
	...
	public List<LOperation> getOperations() {
		...
		Iterable<LOperation> _filter = Iterables.<LOperation> filter(_features,
				LOperation.class);
		List<LOperation> _list = IterableExtensions
				.<LOperation> toList(_filter);
		return _list;
	}
	...
	public List<LEntityReference> getReferences() {
		EList<LEntityFeature> _features = this.getFeatures();
		Iterable<LEntityReference> _filter = Iterables
				.<LEntityReference> filter(_features, LEntityReference.class);
		List<LEntityReference> _list = IterableExtensions
				.<LEntityReference> toList(_filter);
		return _list;
	}
	...
	public List<LEntityAttribute> getAttributes() {
		EList<LEntityFeature> _features = this.getFeatures();
		Iterable<LEntityAttribute> _filter = Iterables
				.<LEntityAttribute> filter(_features, LEntityAttribute.class);
		List<LEntityAttribute> _list = IterableExtensions
				.<LEntityAttribute> toList(_filter);
		return _list;
	}
	...
	public List<LEntityFeature> getAllFeatures() {
		final List<LEntityFeature> result = CollectionLiterals
				.<LEntityFeature> newArrayList();
	...
	public List<LEntityAttribute> getAllAttributes() {
		...
		this.collectAllLunFeatures(this, result);
		Iterable<LEntityAttribute> _filter = Iterables
				.<LEntityAttribute> filter(result, LEntityAttribute.class);
	...
	public List<LEntityReference> getAllReferences() {
		...
		this.collectAllLunFeatures(this, result);
		Iterable<LEntityReference> _filter = Iterables
				.<LEntityReference> filter(result, LEntityReference.class);
	 ...
	 * @generated
	 */
	public void collectAllLunFeatures(final LEntity current,
			final List<LEntityFeature> result) {
	...
	public void eSet(int featureID, Object newValue) {
		...
		case EntityPackage.LENTITY__FEATURES:
			getFeatures().clear();
			getFeatures().addAll(
					(Collection<? extends LEntityFeature>) newValue);
			return;
		case EntityPackage.LENTITY__INDEXES:
			getIndexes().clear();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == LFeaturesHolder.class) {
			...
			case LunTypesPackage.LFEATURES_HOLDER___GET_FEATURES:
				return EntityPackage.LENTITY___GET_FEATURES;
			case LunTypesPackage.LFEATURES_HOLDER___GET_ALL_FEATURES:
				return EntityPackage.LENTITY___GET_ALL_FEATURES;
			default:
				return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case EntityPackage.LENTITY___COLLECT_ALL_LUN_FEATURES__LENTITY_LIST:
			collectAllLunFeatures((LEntity) arguments.get(0),
					(List<LEntityFeature>) arguments.get(1));
			return null;
		}
