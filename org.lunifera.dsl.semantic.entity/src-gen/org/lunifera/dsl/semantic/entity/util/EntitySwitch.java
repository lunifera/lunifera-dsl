...
public class EntitySwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case EntityPackage.LE_OPERATION:
      {
        LEOperation leOperation = (LEOperation)theEObject;
        T result = caseLEOperation(leOperation);
        if (result == null) result = caseLOperation(leOperation);
        if (result == null) result = caseLunTypes_LOperation(leOperation);
        if (result == null) result = caseLBeanFeature(leOperation);
        if (result == null) result = caseLEntityFeature(leOperation);
        if (result == null) result = caseLFeature(leOperation);
        if (result == null) result = caseLAnnotationTarget(leOperation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>LE Operation</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>LE Operation</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLEOperation(LEOperation object)
  {
    return null;
  }
