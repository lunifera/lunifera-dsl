...
public class ServicesGrammarStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.lunifera.dsl.services.xtext.ServicesGrammarRuntimeModule());
	}
	...
	public void register(Injector injector) {
		...
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("services", serviceProvider);
