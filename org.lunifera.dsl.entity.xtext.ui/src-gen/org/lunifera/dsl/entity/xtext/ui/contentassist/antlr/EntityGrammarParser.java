		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBeanFeatureAccess().getAlternatives_2_2_1(), "rule__BeanFeature__Alternatives_2_2_1");
					put(grammarAccess.getBeanFeatureAccess().getAlternatives_2_2_1_1_0(), "rule__BeanFeature__Alternatives_2_2_1_1_0");
					...
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_2_1_0(), "rule__BeanFeature__Group_2_2_1_0__0");
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_2_1_1(), "rule__BeanFeature__Group_2_2_1_1__0");
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_3(), "rule__BeanFeature__Group_2_3__0");
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_3_1(), "rule__BeanFeature__Group_2_3_1__0");
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_3_1_4(), "rule__BeanFeature__Group_2_3_1_4__0");
					put(grammarAccess.getBeanFeatureAccess().getGroup_2_3_1_4_1(), "rule__BeanFeature__Group_2_3_1_4_1__0");
					...
					put(grammarAccess.getEntityFeatureAccess().getDerivedGetterExpressionAssignment_2_1_1_1_4(), "rule__EntityFeature__DerivedGetterExpressionAssignment_2_1_1_1_4");
					...
					put(grammarAccess.getBeanFeatureAccess().getTypeAssignment_2_1_2(), "rule__BeanFeature__TypeAssignment_2_1_2");
					put(grammarAccess.getBeanFeatureAccess().getNameAssignment_2_1_3(), "rule__BeanFeature__NameAssignment_2_1_3");
					put(grammarAccess.getBeanFeatureAccess().getTransientAssignment_2_2_1_0_0(), "rule__BeanFeature__TransientAssignment_2_2_1_0_0");
					put(grammarAccess.getBeanFeatureAccess().getTypeAssignment_2_2_1_0_1(), "rule__BeanFeature__TypeAssignment_2_2_1_0_1");
					put(grammarAccess.getBeanFeatureAccess().getNameAssignment_2_2_1_0_2(), "rule__BeanFeature__NameAssignment_2_2_1_0_2");
					put(grammarAccess.getBeanFeatureAccess().getIdAssignment_2_2_1_1_0_1(), "rule__BeanFeature__IdAssignment_2_2_1_1_0_1");
					put(grammarAccess.getBeanFeatureAccess().getVersionAssignment_2_2_1_1_0_2(), "rule__BeanFeature__VersionAssignment_2_2_1_1_0_2");
					put(grammarAccess.getBeanFeatureAccess().getTypeAssignment_2_2_1_1_1(), "rule__BeanFeature__TypeAssignment_2_2_1_1_1");
					put(grammarAccess.getBeanFeatureAccess().getMultiplicityAssignment_2_2_1_1_2(), "rule__BeanFeature__MultiplicityAssignment_2_2_1_1_2");
					put(grammarAccess.getBeanFeatureAccess().getNameAssignment_2_2_1_1_3(), "rule__BeanFeature__NameAssignment_2_2_1_1_3");
					put(grammarAccess.getBeanFeatureAccess().getTypeAssignment_2_3_1_1(), "rule__BeanFeature__TypeAssignment_2_3_1_1");
					put(grammarAccess.getBeanFeatureAccess().getNameAssignment_2_3_1_2(), "rule__BeanFeature__NameAssignment_2_3_1_2");
					put(grammarAccess.getBeanFeatureAccess().getParamsAssignment_2_3_1_4_0(), "rule__BeanFeature__ParamsAssignment_2_3_1_4_0");
					put(grammarAccess.getBeanFeatureAccess().getParamsAssignment_2_3_1_4_1_1(), "rule__BeanFeature__ParamsAssignment_2_3_1_4_1_1");
					put(grammarAccess.getBeanFeatureAccess().getBodyAssignment_2_3_1_6(), "rule__BeanFeature__BodyAssignment_2_3_1_6");
