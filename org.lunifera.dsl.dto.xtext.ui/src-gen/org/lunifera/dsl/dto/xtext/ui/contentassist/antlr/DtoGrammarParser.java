...
* generated by Xtext
*/
package org.lunifera.dsl.dto.xtext.ui.contentassist.antlr;
...
public class DtoGrammarParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.lunifera.dsl.dto.xtext.ui.contentassist.antlr.internal.InternalDtoGrammarParser createParser() {
		org.lunifera.dsl.dto.xtext.ui.contentassist.antlr.internal.InternalDtoGrammarParser result = new org.lunifera.dsl.dto.xtext.ui.contentassist.antlr.internal.InternalDtoGrammarParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDtoFeatureAccess().getAlternatives_2_4_1(), "rule__DtoFeature__Alternatives_2_4_1");
					put(grammarAccess.getDtoFeatureAccess().getAlternatives_2_5_2(), "rule__DtoFeature__Alternatives_2_5_2");
					put(grammarAccess.getDtoFeatureAccess().getAlternatives_2_6_5(), "rule__DtoFeature__Alternatives_2_6_5");
					...
					put(grammarAccess.getDtoFeatureAccess().getGroup_2_5_1(), "rule__DtoFeature__Group_2_5_1__0");
					put(grammarAccess.getDtoFeatureAccess().getGroup_2_5_1_5(), "rule__DtoFeature__Group_2_5_1_5__0");
					...
					put(grammarAccess.getDtoFeatureAccess().getGroup_2_7_1(), "rule__DtoFeature__Group_2_7_1__0");
					put(grammarAccess.getDtoFeatureAccess().getGroup_2_7_1_4(), "rule__DtoFeature__Group_2_7_1_4__0");
					put(grammarAccess.getDtoFeatureAccess().getGroup_2_7_1_4_1(), "rule__DtoFeature__Group_2_7_1_4_1__0");
					...
					put(grammarAccess.getDtoFeatureAccess().getMapperAssignment_2_0_2_0(), "rule__DtoFeature__MapperAssignment_2_0_2_0");
					...
					put(grammarAccess.getDtoFeatureAccess().getMapperAssignment_2_1_4_0(), "rule__DtoFeature__MapperAssignment_2_1_4_0");
					...
					put(grammarAccess.getDtoFeatureAccess().getCascadingAssignment_2_5_1_1(), "rule__DtoFeature__CascadingAssignment_2_5_1_1");
					put(grammarAccess.getDtoFeatureAccess().getTypeAssignment_2_5_1_2(), "rule__DtoFeature__TypeAssignment_2_5_1_2");
					put(grammarAccess.getDtoFeatureAccess().getMultiplicityAssignment_2_5_1_3(), "rule__DtoFeature__MultiplicityAssignment_2_5_1_3");
					put(grammarAccess.getDtoFeatureAccess().getNameAssignment_2_5_1_4(), "rule__DtoFeature__NameAssignment_2_5_1_4");
					put(grammarAccess.getDtoFeatureAccess().getOppositeAssignment_2_5_1_5_1(), "rule__DtoFeature__OppositeAssignment_2_5_1_5_1");
					put(grammarAccess.getDtoFeatureAccess().getMapperAssignment_2_5_2_0(), "rule__DtoFeature__MapperAssignment_2_5_2_0");
					put(grammarAccess.getDtoFeatureAccess().getTypeAssignment_2_6_2(), "rule__DtoFeature__TypeAssignment_2_6_2");
					put(grammarAccess.getDtoFeatureAccess().getMultiplicityAssignment_2_6_3(), "rule__DtoFeature__MultiplicityAssignment_2_6_3");
					put(grammarAccess.getDtoFeatureAccess().getNameAssignment_2_6_4(), "rule__DtoFeature__NameAssignment_2_6_4");
					put(grammarAccess.getDtoFeatureAccess().getMapperAssignment_2_6_5_0(), "rule__DtoFeature__MapperAssignment_2_6_5_0");
					put(grammarAccess.getDtoFeatureAccess().getTypeAssignment_2_7_1_1(), "rule__DtoFeature__TypeAssignment_2_7_1_1");
					put(grammarAccess.getDtoFeatureAccess().getNameAssignment_2_7_1_2(), "rule__DtoFeature__NameAssignment_2_7_1_2");
					put(grammarAccess.getDtoFeatureAccess().getParamsAssignment_2_7_1_4_0(), "rule__DtoFeature__ParamsAssignment_2_7_1_4_0");
					put(grammarAccess.getDtoFeatureAccess().getParamsAssignment_2_7_1_4_1_1(), "rule__DtoFeature__ParamsAssignment_2_7_1_4_1_1");
					put(grammarAccess.getDtoFeatureAccess().getBodyAssignment_2_7_1_6(), "rule__DtoFeature__BodyAssignment_2_7_1_6");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.lunifera.dsl.dto.xtext.ui.contentassist.antlr.internal.InternalDtoGrammarParser typedParser = (org.lunifera.dsl.dto.xtext.ui.contentassist.antlr.internal.InternalDtoGrammarParser) parser;
