 ...
 * example
 */
public class OrganizationGrammarFormatter extends AbstractDeclarativeFormatter {

	@Override
	protected void configureFormatting(FormattingConfig c) {
		OrganizationGrammarGrammarAccess gac = (OrganizationGrammarGrammarAccess) getGrammarAccess();
