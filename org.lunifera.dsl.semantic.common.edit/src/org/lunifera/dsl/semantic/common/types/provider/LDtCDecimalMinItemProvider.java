...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.common.types.LDtCDecimalMin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LDtCDecimalMinItemProvider extends LLazyResolverItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LunTypesPackage.Literals.LDT_CDECIMAL_MIN__MIN,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		LDtCDecimalMin lDtCDecimalMin = (LDtCDecimalMin)object;
		return getString("_UI_LDtCDecimalMin_type") + " " + lDtCDecimalMin.getMin();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LDtCDecimalMin.class)) {
			case LunTypesPackage.LDT_CDECIMAL_MIN__MIN:
