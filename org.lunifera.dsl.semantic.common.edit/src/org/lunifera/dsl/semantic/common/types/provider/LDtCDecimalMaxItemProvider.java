...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.common.types.LDtCDecimalMax} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LDtCDecimalMaxItemProvider extends LLazyResolverItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LunTypesPackage.Literals.LDT_CDECIMAL_MAX__MAX,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		LDtCDecimalMax lDtCDecimalMax = (LDtCDecimalMax)object;
		return getString("_UI_LDtCDecimalMax_type") + " " + lDtCDecimalMax.getMax();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LDtCDecimalMax.class)) {
			case LunTypesPackage.LDT_CDECIMAL_MAX__MAX:
