...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.common.types.LDtCSize} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LDtCSizeItemProvider extends LLazyResolverItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LunTypesPackage.Literals.LDT_CSIZE__MIN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LunTypesPackage.Literals.LDT_CSIZE__MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		LDtCSize lDtCSize = (LDtCSize)object;
		return getString("_UI_LDtCSize_type") + " " + lDtCSize.getMin();
	}
