/**
 */
package org.lunifera.dsl.component.semantic.model.impl;
...
import org.lunifera.dsl.component.semantic.model.ComponentFactory;
import org.lunifera.dsl.component.semantic.model.ComponentModel;
import org.lunifera.dsl.component.semantic.model.ComponentPackage;
import org.lunifera.dsl.component.semantic.model.UnitType;
...
public class ComponentPackageImpl extends EPackageImpl implements ComponentPackage {
	 ...
	 * @see org.lunifera.dsl.component.semantic.model.ComponentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getComponentModel_Name() {
		return (EAttribute)componentModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getComponentModel_UnitTypes() {
	...
	public void createPackageContents() {
		...
		createEReference(componentModelEClass, COMPONENT_MODEL__UNIT_TYPES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getComponentModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, ComponentModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponentModel_UnitTypes(), this.getUnitType(), null, "unitTypes", null, 0, -1, ComponentModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(unitTypeEClass, UnitType.class, "UnitType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUnitType_Name(), ecorePackage.getEString(), "name", null, 0, 1, UnitType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
