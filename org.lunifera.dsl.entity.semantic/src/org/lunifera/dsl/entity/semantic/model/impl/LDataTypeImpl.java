 ...
 * <ul>
 *   <li>{@link org.lunifera.dsl.entity.semantic.model.impl.LDataTypeImpl#getJvmTypeReference <em>Jvm Type Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LDataTypeImpl extends LScalarTypeImpl implements LDataType {
	...
	protected EClass eStaticClass() {
		return EntityPackage.Literals.LDATA_TYPE;
	}
	...
	public NotificationChain basicSetJvmTypeReference(JvmTypeReference newJvmTypeReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EntityPackage.LDATA_TYPE__JVM_TYPE_REFERENCE, oldJvmTypeReference, newJvmTypeReference);
	...
	public void setJvmTypeReference(JvmTypeReference newJvmTypeReference) {
		if (newJvmTypeReference != jvmTypeReference) {
			...
			if (jvmTypeReference != null)
				msgs = ((InternalEObject)jvmTypeReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EntityPackage.LDATA_TYPE__JVM_TYPE_REFERENCE, null, msgs);
			if (newJvmTypeReference != null)
				msgs = ((InternalEObject)newJvmTypeReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EntityPackage.LDATA_TYPE__JVM_TYPE_REFERENCE, null, msgs);
			msgs = basicSetJvmTypeReference(newJvmTypeReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.LDATA_TYPE__JVM_TYPE_REFERENCE, newJvmTypeReference, newJvmTypeReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EntityPackage.LDATA_TYPE__JVM_TYPE_REFERENCE:
