...
public class FooDtoMapper<DTO extends FooDto, ENTITY extends Foo> implements IMapper<DTO, ENTITY> {
  ...
  public String createDtoHash(final Object in) {
    return org.lunifera.runtime.common.hash.HashUtil.createObjectWithIdHash(FooDto.class, in);
  }
  
  public String createEntityHash(final Object in) {
    return org.lunifera.runtime.common.hash.HashUtil.createObjectWithIdHash(Foo.class, in);
  }
}
