...
public class EmployeeDto extends PersonDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public void copyContainments(final EmployeeDto dto, final EmployeeDto newDto, final MappingContext context) {
    ...
    for(org.lunifera.dsl.entity.xtext.tests.model.testcarstore2.dtos.EmployeeDto _dto : getSubordinates()) {
    	newDto.addToSubordinates(_dto.copy(context));
    }
  }
  
  public void copyCrossReferences(final EmployeeDto dto, final EmployeeDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
