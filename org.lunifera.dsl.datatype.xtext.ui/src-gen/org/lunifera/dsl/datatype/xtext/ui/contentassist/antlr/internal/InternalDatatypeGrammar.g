...
:
(
{ before(grammarAccess.getLCommonModelAccess().getPackagesTypedPackageParserRuleCall_0()); }
	ruleTypedPackage{ after(grammarAccess.getLCommonModelAccess().getPackagesTypedPackageParserRuleCall_0()); }
)
...
:
(
{ before(grammarAccess.getTypedPackageAccess().getTypesScalarTypeParserRuleCall_3_2_0()); }
	ruleScalarType{ after(grammarAccess.getTypedPackageAccess().getTypesScalarTypeParserRuleCall_3_2_0()); }
)
